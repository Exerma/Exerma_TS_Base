 ...
 */
    ...
    export class CLanguage {
         ...
         *              is undefined
         * @param {boolean} options.feminine is used to inform the system that the subject is feminine (and not neutral)
         * @param {boolean} options.masculin is used to inform the system that the subject is masculin (and not neutral)
         * @param {number} options.count is the number of object(s) if there is a difference between one, two or many objects
