 ...
 */
    ...
    /**
     * Check if an item is of type "number"
     * @param {any} x is the item to test if a number
     * @returns {boolean} is true if the provided x item is a number
     */
    ...
    /**
     * Check if an item is of type "object"
     * @param {any} x is the item to test if an object
     * @returns {boolean} is true if the provided x item is an object
     */
    ...
    /**
     * Check if an item is of type "string"
     * @param {any} x is the item to test if a string
     * @returns {boolean} is true if the provided x item is a string
     */
    ...
    /**
     * Check if an item is of type "boolean"
     * @param {any} x is the item to test if a boolean
     * @returns {boolean} is true if the provided x item is a boolean
     */
