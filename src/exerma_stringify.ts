 ...
 * 
 * Versions:
 *   2024-08-10: Fix: Minor change in type of data
 ...
 */
    ...
    // --------------- Import
    import * as ex from './exerma_types'
    ...
    function safeStringifyAny ( source: any,
        ...
        try {
            ...
            if (typeof source === cTypeNameObject ) {
                return safeStringifyObject(source as object)
            }
    ...
    function safeUnstringifyAsSafeValue (source: string | SafeItem,
        ...
        try {
            ...
            const result: uSafeItem =  safeUnstringifyAsSafeItem(source,
                                                                controlDescr,
                                                                expectedType,
    ...
    function safeUnstringifyAsSafeList (source: string | SafeItem,
        ...
        try {
            ...
            const safeItemObj = safeUnstringifyAsSafeItem(source, controlDescr, expectedType)
